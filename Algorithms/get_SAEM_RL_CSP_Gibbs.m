...
function [num_act1,num_act2, theta, theta2,gamma,p,q,A1_sample_long, A2_sample_long,Z,prop, B1, B2, A1_new, A2_new, it_num] = get_SAEM_RL_CSP_Gibbs(X, Z, R, Rlevels, prop_in, gamma_in,B1_in, B2_in, A1_in, A2_in, C, it,t1,t2,temp,tau)
