## ============================================================
## LOOPR Prayer: 100-run predictive analysis
## ============================================================
...
## ============================================================
## Prayer outcome
## Keep all observed levels unchanged
## ============================================================
...
LOOPR_pew_prayer <- vector("list",nRep)
...
for(r in seq_len(nRep)){
  ...
  cat("\n============================================================\n")
  cat("LOOPR prayer repetition:",r,"/",nRep,"\n")
  cat("============================================================\n")
  ...
  if(r %% 5==0){
    ...
    saveRDS(
      LOOPR_pew_prayer,
      file.path(results_dir,"LOOPR_pew_prayer.rds")
    )
...
cat("\nCompleted",length(LOOPR_pew_prayer),"LOOPR prayer repetitions.\n")