## ============================================================
## IPIP-98 Voting Registration: 100-run predictive analysis
## ============================================================
...
## ============================================================
## Voting registration
## 1 = Yes, 2 = No, 3 = Don't know -> discard
## ============================================================

votereg <- Y$votereg

keep <- !is.na(votereg) & votereg %in% c(1,2)
...
IPIP98_votereg <- vector("list",nRep)
...
for(r in seq_len(nRep)){
  ...
  cat("\n============================================================\n")
  cat("Voting-registration repetition:",r,"/",nRep,"\n")
  cat("============================================================\n")
  ...
  if(r %% 5==0){
    ...
    saveRDS(
      IPIP98_votereg,
      file.path(results_dir,"IPIP98_votereg.rds")
    )
...
cat("\nCompleted",length(IPIP98_votereg),"voting-registration repetitions.\n")