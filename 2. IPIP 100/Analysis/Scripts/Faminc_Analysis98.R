## ============================================================
## IPIP-98 Family Income: 100-run predictive analysis
## ============================================================
...
IPIP98_faminc <- vector("list",nRep)
...
for(r in seq_len(nRep)){
  ...
  cat("\n============================================================\n")
  cat("Family-income repetition:",r,"/",nRep,"\n")
  cat("============================================================\n")
  ...
  if(r %% 5==0){
    ...
    saveRDS(
      IPIP98_faminc,
      file.path(results_dir,"IPIP98_faminc.rds")
    )
...
cat("\nCompleted",length(IPIP98_faminc),"family-income repetitions.\n")