## ============================================================
## IPIP-98 Prayer: 100-run predictive analysis
## ============================================================
...
IPIP98_pew_prayer <- vector("list",nRep)
...
for(r in seq_len(nRep)){
  ...
  if(r %% 5==0){
    ...
    saveRDS(
      IPIP98_pew_prayer,
      file.path(results_dir,"IPIP98_pew_prayer.rds")
    )
...
cat("\nCompleted",length(IPIP98_pew_prayer),"prayer repetitions.\n")