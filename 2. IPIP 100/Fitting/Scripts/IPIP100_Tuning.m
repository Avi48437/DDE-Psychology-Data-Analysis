...
addpath(fullfile(root_dir, '2. IPIP 100'));
%% Load the IPIP-100 data
data_file = fullfile(root_dir, '2. IPIP 100', 'B5.csv');
...
taus = [.1,.2,.4];
t1s = [.02,.04,.06];
t2s = [0.001,0.002,.02,.04,.06,.08];
temps = [.7,.8,.9];
% Best Settings Found 0.2,0.02,0.06,0.7
...
%% Plot the Best fitted B1 and B2
B1_CSP = best_B1_CSP;
B2_CSP = best_B2_CSP;
%%
